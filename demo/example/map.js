...
export default function() {
    return (
        <Recharts bmap={bmap} notMerge>
            <Title text="全国主要城市空气质量 - 百度地图" subtext="data from PM25.in" sublink="http://www.pm25.in" left="center" />
            ...
            <Series
                ...
                showEffectOn="render"
                hoverAnimation={true}
                itemStyle={{ normal: { color: 'purple', shadowBlur: 10, shadowColor: '#333' } }}
                zlevel={1}>
                <RippleEffect brushType="stroke" /> <Label normal={{ formatter: '{b}', position: 'right', show: true }} />
            </Series>
        </Recharts>
    )
}
