...
export default function() {
    return (
        <Recharts backgroundColor="#404a59" color={['#dd4444', '#fec42c', '#80F1BE']}>
            <Legend y="top" data={['北京', '上海', '广州']} textStyle={{ color: '#fff', fontSize: 16 }} />
            <Grid x="10%" x2={150} y="18%" y2="10%" />
            <Tooltip padding={10} backgroundColor="#222" borderColor="#777" borderWidth={1} formatter={formatter} />
            <XAxis
                type="value"
                name="日期"
                nameGap={16}
            ...
            <VisualMap
                ...
                controller={{ inRange: { color: ['#c23531'] }, outOfRange: { color: ['#444'] } }}
            />
            <Series name="北京" type="scatter" itemStyle={itemStyle} data={dataBJ} />
            <Series name="上海" type="scatter" itemStyle={itemStyle} data={dataSH} />
            <Series name="广州" type="scatter" itemStyle={itemStyle} data={dataGZ} />
        </Recharts>
    )
}
